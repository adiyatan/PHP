...
<body>
    <div class="container">
        ...
        <a href="cetak.php" class="btn btn-secondary mb-3 no-print" target="_blank">Print</a>
        <a class="add-link btn btn-primary mb-3" href="tambah.php">Add Car Data</a>
        <form action="" method="post" class="mb-3">
            <div class="input-group">
                <input type="text" name="keyword" class="form-control" placeholder="Find here" autocomplete="off" autofocus id="keyword">
                <div class="input-group-append">
                    <button type="submit" name="cari" class="btn btn-primary" id="tombol-cari">Find</button>
                </div>
            </div>
            <!-- New row for the loader -->
            <div class="row">
                <div class="col-md-12 text-center">
                    <img src="img/mobil.gif" alt="Loader" id="loader" style="display: none;">
                </div>
            </div>
        </form>
