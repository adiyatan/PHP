...
<body>
    <div class="container">
        <h1 class="text-center mt-3">Change Car Data</h1>
        <a class="add-link btn btn-primary mb-3" href="index.php">Back</a>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <ul class="list-unstyled">
                ...
                <br>
                <li>
                    <button type="submit" name="submit" class="submit-btn btn btn-primary">Change Car Data</button>
                </li>
            </ul>
        </form>
    </div>
