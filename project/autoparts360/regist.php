...
<body>
    <div class="container mt-5">
        ...
        <div class="form-wrapper">
            ...
            <form class="row g-3 needs-validation" novalidate id="registration-form" onsubmit="validateForm(event)" action="" method="post">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div id="password-match-message" class="invalid-feedback" style="display: none;">
                        Passwords match.
                    </div>
